...
Example code can be find [here](https://github.com/damiandrzewicz/algorithms_cpp/blob/3888e6483e629bfeab6581b5aa7d912980535c7b/src/sequential_bubble_sort.cpp) in my repository. For generating random numbers I used `Mersenne` random generator.
